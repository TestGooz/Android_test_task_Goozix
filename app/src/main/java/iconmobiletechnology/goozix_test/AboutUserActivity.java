...
public class AboutUserActivity extends AppCompatActivity {
    ...
    private static final  String  AUTORIZATION_USER_MODEL  =  "AUTORIZATION_USER_MODEL" ;
    ...
    public static Intent getStartIntentAuth(Context context, int mTypeUser) {
        ...
        intent.putExtra(TYPE_USER, mTypeUser);
        return intent;
    }
    ...
    public static Intent getStartIntentUser(Context context, String mUserLogin, int mTypeUser) {
        Intent intent = new Intent(context, ReposActivity.class);
        intent.putExtra(TYPE_USER, mTypeUser);
        intent.putExtra(USER_LOGIN, mUserLogin);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTypeUser = (int) getIntent().getSerializableExtra(TYPE_USER);
        if (mTypeUser == 0) {
            AutorizationUserModel mAuthUser = (AutorizationUserModel) getIntent().getSerializableExtra(AUTORIZATION_USER_MODEL);
        ...
        {
            mUserLogin = (String) getIntent().getSerializableExtra(USER_LOGIN);
            getUserProfile();
        }
    }
    ...
    private void getUserProfile()
    {
        ...
        User.enqueue(new Callback<User>() {
            ...
            public void onResponse(@NonNull Call<User> call, @NonNull Response<User> response) {
                ...
                else Toast.makeText(AboutUserActivity.this, response.message(), Toast.LENGTH_SHORT).show();
            }
