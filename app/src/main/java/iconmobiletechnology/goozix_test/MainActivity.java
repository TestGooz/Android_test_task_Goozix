...
public class MainActivity extends AppCompatActivity
    ...
    public static Intent getStartIntentAboutAuth(Context context, AutorizationUserModel AuthUser) {
        ...
        intent.putExtra(AUTORIZATION_USER_MODEL, AuthUser);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthUser = (AutorizationUserModel) getIntent().getSerializableExtra(AUTORIZATION_USER_MODEL);
    ...
    protected void onActivityResult (int requestCode, int resultCode, Intent data) {
        if(requestCode == REQ_CODE_CHILD) {
            if (data != null) {
                mAuthUser = (AutorizationUserModel) Objects.requireNonNull(data.getExtras()).getSerializable(AUTORIZATION_USER_MODEL);
